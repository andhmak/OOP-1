...
Οι μαθητές κάθε χώρου αποθηκεύονται σε μορφή πίνακα δεικτών σε αντικείμενα μαθητών. Χρησιμοποιείται πίνακας αφού η χωρητικότητα είναι γνωστό από την
δημιουργία του αντικειμένου κάθε χώρου και δεν αλλάζει μέχρι την καταστροφή του.
Η συναρτήσεις enter της κλάσης School επιστρέφουν bool, το οποίο είναι false όταν ένας μαθητής που έδωσε ο χρήστης δεν μπόρεσε να μπει στο σχολείο
...
Οι κλάσεις Class, Corridor, Floor, Stairs, Yard είναι ορατές στον χρήστη, παρόλο που ενδείκνυται η χρήση τους μόνο έμμεσα μέσω της School, εφόσον
έγινε η διευκρίνηση πως δεν υπάρχει λόγος να τις κρύψουμε.
Όταν η enter δέχεται έναν μαθητή τον μετακινεί όσο πιο "κοντά" στην τάξη του μπορεί.
Όταν δέχεται πολλούς τους μετακινεί σε "κύματα" μέχρι τον όροφο. Γεμίζει κάθε χώρο, και μετά παίρνει μαθητές από αυτόν και γεμίζει τον επόμενο,
...
πότε μπορούν να μετακινηθούν μαθητές. Η Floor έχει μια συνάρτηση που κάνει ουσιαστικά το ίδιο πράγμα, επιστρέφοντας αν είναι γεμάτος ο διάδρομος.
Υπάρχει ονοματα ένα αρχείο names.h με ονόματα από όπου διαλέγει τυχαία η main όταν δημιουργεί μαθητές και δασκλάλους.
Το πληθος των μαθητων καθορίζεται από την χωρητικότητα των τάξεων (cclass*18), έτσι ώστε σε μια "τέλεια" περίπτωση να γεμίσουν ακριβώς.
